    ...
    <body class="bg-slate-50 text-slate-900 pb-20 text-[12px]">
        ...
        <script>
            ...
            function runBacktest() {
                ...
                document.getElementById('bt-box-3s').className = m3>5 ? "bt-miss-alert px-4 py-1.5 rounded-xl text-[9px] font-black" : "bt-miss-normal px-4 py-1.5 rounded-xl text-[9px] font-black";
                document.getElementById('bt-box-4s').className = m4>5 ? "bt-miss-alert px-4 py-1.5 rounded-xl text-[9px] font-black" : "bt-miss-normal px-4 py-1.5 rounded-xl text-[9px] font-black";
            }
